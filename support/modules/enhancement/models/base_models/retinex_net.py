...
class RelightNet(nn.Module):
    def __init__(self, channel=64, kernel_size=3):
        ...
        self.net2_output = nn.Conv2d(channel, 1, kernel_size=3, padding=1,
...
class RetinexNet(nn.Module):
    """The clean wrapper that combines DecomNet and RelightNet"""
    def __init__(self):
    ...
    def forward(self, input_low):
        ...
        # Return a list so the ensemble can grab the final output using [-1]
        return [R_low, I_low, I_delta_3, output]