    ...
    def __init__(self, filters=16, activation='lrelu'):
        ...
        gauss = torch.tensor(
            [[0.0947416, 0.118318, 0.0947416],
             ...
             [0.0947416, 0.118318, 0.0947416]], dtype=torch.float32)
        self.register_buffer('Gauss_kernel', gauss.unsqueeze(0).unsqueeze(0))
        self.w = nn.Parameter(torch.tensor(0.72))
...
class KinD(nn.Module):
    ...
    def forward(self, L, ratio=5.0): # Added default ratio
